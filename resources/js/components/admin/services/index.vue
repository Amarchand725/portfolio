<script setup>
    ...
    const createService = async () => {
        await axios.post('/api/admin/service/create', form.value)
        .then(response  => {
            getServices(),
            closeModal(),
            toast.fire({
    ...
    const updateService = async () => {
        await axios.post('/api/admin/service/update/'+form.value.id, form.value)
        .then(() => {
            getServices()
            closeModal()
            toast.fire({
    ...
    const deleteService = (id) => {
        ...
        .then((result) => {
            if(result.value){
                axios.get('/api/admin/service/destroy/'+id)
                .then(() => {
                    Swal.fire(
                        'Delete',
